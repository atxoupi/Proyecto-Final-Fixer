  ...
  return {
    ...
    actions: {
      ...
      createRequest: async (city, sector, description) => {
        ...
        fetch(
          "https://3001-atxoupi-proyectofinalfi-xu8j8smzvjn.ws-eu53.gitpod.io/api/work_request",
          requestOptions
        )
      ...
      createUser: async (name, lastname, email, password) => {
        ...
        fetch(
          "https://3001-atxoupi-proyectofinalfi-xu8j8smzvjn.ws-eu53.gitpod.io/api/user_signup",
          requestOptions
        )
          .then((response) => response.text())
          .then((result) => console.log(result))
      ...
      createWorker: async (name, city, email, password, sector) => {
        ...
        fetch(
          "https://3001-atxoupi-proyectofinalfi-xu8j8smzvjn.ws-eu53.gitpod.io/api/worker_signup",
          requestOptions
        )
          .then((response) => response.text())
          .then((result) => console.log(result))
